...
ROUTE_WAYPOINTS: dict[str, list[dict]] = {
    ...
    # ── 남극(아라온 양극 운항) 항로 ──────────────────────────────────────
    "ROSS": [
        {"name": "리틀턴항", "lat": -43.6, "lon": 172.72},
        {"name": "뱅크스 반도 동방 외해", "lat": -44.1, "lon": 173.4},
        {"name": "뉴질랜드 남동 외해", "lat": -46.5, "lon": 174.8},
        {"name": "남태평양 남하", "lat": -50.0, "lon": 176.5},
        {"name": "남극순환류(ACC) 진입", "lat": -54.0, "lon": 177.5},
        {"name": "남빙양 해빙 북한계", "lat": -58.0, "lon": 177.0},
        {"name": "로스해 외곽 접근", "lat": -62.0, "lon": 174.5},
        {"name": "로스해 진입(케이프 아데어 동방)", "lat": -66.0, "lon": 172.0},
        {"name": "로스해 북서부", "lat": -69.5, "lon": 170.5},
        {"name": "빅토리아랜드 외해 남하", "lat": -72.0, "lon": 168.5},
        {"name": "테라노바만 접근", "lat": -73.6, "lon": 166.5},
        {"name": "장보고기지", "lat": -74.62, "lon": 164.23},
    ],
    "PENINSULA": [
        {"name": "푼타아레나스항", "lat": -53.16, "lon": -70.92},
        {"name": "마젤란 해협 동부", "lat": -52.7, "lon": -69.3},
        {"name": "마젤란 해협 대서양측 출구", "lat": -52.5, "lon": -68.3},
        {"name": "에스타도스 섬 동방 외해", "lat": -54.2, "lon": -67.0},
        {"name": "드레이크 해협(스코샤해)", "lat": -57.0, "lon": -65.0},
        {"name": "남극수렴선 통과", "lat": -59.5, "lon": -62.5},
        {"name": "사우스셰틀랜드 북방 접근", "lat": -61.4, "lon": -60.2},
        {"name": "세종기지(킹조지섬)", "lat": -62.22, "lon": -58.78},
    ],
}
